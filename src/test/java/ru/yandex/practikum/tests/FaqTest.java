...
public class FaqTest extends BaseTest {
    ...
    @Test
    public void checkFaqQuestionAndAnswerTest() {
        ...
        String expected = expectedQuestion + " | " + expectedAnswer;
        String actual = actualQuestion + " | " + actualAnswer;

        assertEquals("Несовпадение пары вопрос-ответ № " + questionIndex,
                expected, actual);
    }
}